#!/usr/bin/env bash
# Build the intbig cross-validation harness.
...
INC_TUTIL="$REF/src/common/generic/include"

# The intbig.o and finit.o are compiled as part of the quaternion library.
# We also need mini-gmp and the RNG stub.
...
cc -O2 -o "$SCRIPT_DIR/intbig_cval" \
    "$SCRIPT_DIR/intbig_validate.c" \
    -DMINI_GMP \
    -DRADIX_64 \
    -I"$INC_COMMON" \
    -I"$INC_INTBIG" \
...
echo "Built: $SCRIPT_DIR/intbig_cval"
